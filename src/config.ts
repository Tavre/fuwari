...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "https://cdn.jsdelivr.net/gh/TenKavr/test_gi@main/images/20241022004016692.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	avatar: "https://q1.qlogo.cn/g?b=qq&nk=2987304764&s=640", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Tavre",
	bio: "TenKavr\n美好的事情即将发生！",
	links: [
		{
